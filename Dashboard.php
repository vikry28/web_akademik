          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                <span>Welcome,</span>
                <h2>Vickry Taufik Firmansyah</h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  <li><a href="Beranda.html"><i class="fa fa-home"></i> Home <span class="fa fa-chevron"></span></a>
                  </li>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" >
                  <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="img/user.png" alt="">Vickry Taufik Firmansyah
                  </a>
      ...
      switch ($queries['page']) {
        ...
        <footer>
          <div class="pull-right">
            @Copyright by 18111168_Vickry Taufik Firmansyah_TIFRP 18 CIDB_UASWEB1
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
